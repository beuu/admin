                            ...
                            <div class="m-portlet__head-tools">
                               ...
                               <form class="form-horizontal" role="form" method="POST"
                                   ...
                                   <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                       ...
                                       <div class="col-md-12">
                                                     <textarea id="description" name="description" class="form-control my-editor">{{$data2->description}}</textarea>
                                   ...
                                   <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                                       <label for="email" class="col-md-12 control-label">Nội Dung </label>
       
                                       <div class="col-md-12">
                                                     <textarea id="description" name="body" rows="40" class="form-control my-editor">{{$data2->body}}</textarea>
                                           @if ($errors->has('body'))
                                               <span class="help-block">
