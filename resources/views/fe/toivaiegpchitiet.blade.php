                    ...
                    <ul class="flex-box">
                        ...
                        <li>
                            <ul>
                                ...
                                <li>
                                    <ul class="flex-box">
                                        <li class="flext_list mr_25 pdr_40 text-right">
                                            <h5 class="text-up font24 text-uppercase">Trần Hoài</h5>
                                            <p class="font18">Lớp toán học 3 (2016)</p>
                                        </li>
                                        <li><a href="#"><img src="image/tintuc_5.jpg"></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
